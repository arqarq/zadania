...
public class Streams {
    public static void main(String[] args) {
        ...
        // 1) Napisz stream, który przekształci wszystkie litery w napisach na wielkie, odrzuci napisy, których długość jest nieparzysta i zbierze wyniki do listy.
        ...
        // 3) Używając streamów scal wszystkie napisy w jeden String w taki sposób, aby każdy napis zaczynał się i kończył znakiem "#". Tak zmodyfikowane napisy w wynikowym Stringu powinny być przedzielone przecinkami.
        ...
        // 5) Używając streamów zamień każdą liczbę na jej kwadrat, pozostaw liczby mniejsze od 10, ogranicz ich liczbę do trzech i zbierz wynik do listy.
        ...
        // 6) Wypisz na ekran informację czy na oryginalnej liście znajduje się przynajmniej jedna liczba, która jest podzielna zarówno przez 2, jak i przez 5. Użyj streamów.
